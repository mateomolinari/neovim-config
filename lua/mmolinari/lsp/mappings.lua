local utils = require('mmolinari.utils')
local lsp_utils = require('mmolinari.utils.lsp')
local M = {}
...
function M.init(client, bufnr)
  ...
  buf_map(
    'n',
    '<leader>lwl',
    '<cmd>lua require("mmolinari.utils.logger"):log(vim.inspect(vim.lsp.buf.list_workspace_folders()))<cr>',
